...
router.get(
  ...
  allowRoles([1, 3]),
  createTaskDataController.taskPageOne,
); //Tilføj billeder og/eller produktopfyldningner
router.post(
  "/uploadtaskimage/:taskId",
  allowRoles([1, 3]),
  createTaskDataController.uploadMiddleware,
  createTaskDataController.imageUpload,
); //Tilføj til Pictures table
router.get(
  "/createtaskdata/:taskId/images",
  allowRoles([1, 3]),
  createTaskDataController.viewImages,
); //Se uploadede billeder
router.post(
  "/createtaskdata/:taskId/images",
  allowRoles([1, 3]),
  createTaskDataController.deleteImage,
); //Slet uploadede billeder
router.post(
  "/uploadtask/:taskId",
  allowRoles([1, 3]),
  createTaskDataController.uploadTasks,
); //Tilføj til ProductTask table og send mail til ejer
router.get(
  "/completedtask/:taskId",
  allowRoles([1, 3]),
  createTaskDataController.completedTask,
); //Færdig med task upload
...
router.get(
  "/taskHistorie/:taskId",
  allowRoles([1, 2]),
  taskHistorieController.taskHistorie,
); //Tasks på den valgte tankstation
router.get(
  "/showTaskImages/:imageUuid",
  createTaskDataController.showTaskImages,
); //Side som mail til ejer fører til
...
router.get(
  "/admin/gasstations",
  allowRoles([1]),
  adminListController.adminListGasstations,
);
router.get(
...
router.post(
  "/admin/gasstations/new",
  allowRoles([1]),
  adminListController.newGasstationStart,
);
router.post(
...
router.get(
  "/admin/gasstations/:gasId/tasks",
  allowRoles([1, 2]),
  modifyGasstationController.tasks,
);
router.get(
  "/admin/gasstations/:gasId/users",
  allowRoles([1, 2]),
  modifyGasstationController.users,
);
router.post(
  "/admin/gasstations/:gasId/users/new",
  allowRoles([1]),
  modifyGasstationController.createLinkUser,
);
router.post(
  "/admin/gasstations/:gasId/users/:userId/delete",
  allowRoles([1]),
  modifyGasstationController.removeLinkUser,
);
//-----------ADMIN-USER---------------
...
router.get(
  "/admin/users/:userId",
  allowRoles([1]),
  profileController.adminUser,
);
router.post(
  "/admin/users/new",
  allowRoles([1]),
  adminListController.newUserStart,
);
router.post(
...
router.get(
  ...
  allowRoles([1]),
  profileController.tasks,
);
router.get(
  "/admin/users/:userId/gasstations",
  allowRoles([1]),
  profileController.gasstations,
);
router.post(
  "/admin/users/:userId/gasstations/new",
  allowRoles([1]),
  profileController.linkGasstation,
);
router.post(
  "/admin/users/:userId/gasstations/:gasId/delete",
  allowRoles([1]),
  profileController.removeLinkGasstation,
);
//----------------ADMIN-PRODUCTS---------------
router.get(
  "/admin/products",
  allowRoles([1]),
  adminListController.adminListProducts,
);
router.get(
...
router.post(
  "/admin/products/new",
  allowRoles([1]),
  adminListController.newProductStart,
);
router.post(
...
router.post(
  "/admin/tasks/:taskId/delete/image",
  allowRoles([1]),
